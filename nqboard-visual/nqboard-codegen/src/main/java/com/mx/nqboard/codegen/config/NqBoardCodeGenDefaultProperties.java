package com.mx.nqboard.codegen.config;
...
@ConfigurationProperties(prefix = NqBoardCodeGenDefaultProperties.PREFIX)
public class NqBoardCodeGenDefaultProperties implements InitializingBean {
