...
public class NqBoardAppUserDetailsServiceImpl implements NqBoardUserDetailsService {
	...
	public UserDetails loadUserByUsername(String phone) {
		...
		if (cache != null && cache.get(phone) != null) {
			return (NqBoardUser) cache.get(phone).get();
		}
	...
	/**
	 * 根据用户信息加载用户详情
	 * @param nqBoardUser 用户信息对象
	 * @return 用户详情
	 */
	@Override
	public UserDetails loadUserByUser(NqBoardUser nqBoardUser) {
		return this.loadUserByUsername(nqBoardUser.getPhone());
	}
