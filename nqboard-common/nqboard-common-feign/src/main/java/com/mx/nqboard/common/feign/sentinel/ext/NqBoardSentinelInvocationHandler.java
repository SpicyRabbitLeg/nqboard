 ...
 */
@Slf4j
public class NqBoardSentinelInvocationHandler implements InvocationHandler {
	...
	NqBoardSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			NqBoardSentinelInvocationHandler other = (NqBoardSentinelInvocationHandler) obj;
