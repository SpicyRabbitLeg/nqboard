...
package com.mx.nqboard.common.feign.sentinel.ext;
 ...
 * @date 2025/05/31
 */
public final class NqBoardSentinelFeign {

	private NqBoardSentinelFeign() {

	}

	public static NqBoardSentinelFeign.Builder builder() {
		return new NqBoardSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public NqBoardSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new NqBoardSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new NqBoardSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new NqBoardSentinelInvocationHandler(target, dispatch);
				}
