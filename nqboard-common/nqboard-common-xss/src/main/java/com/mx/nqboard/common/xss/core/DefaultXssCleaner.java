...
package com.mx.nqboard.common.xss.core;

import cn.hutool.core.util.CharsetUtil;
import com.mx.nqboard.common.xss.config.NqBoardXssProperties;
import com.mx.nqboard.common.xss.utils.XssUtil;
...
public class DefaultXssCleaner implements XssCleaner {
	...
	private final NqBoardXssProperties properties;

	public DefaultXssCleaner(NqBoardXssProperties properties) {
	 ...
	 * @return 文档输出设置对象
	 */
	private static Document.OutputSettings getOutputSettings(NqBoardXssProperties properties) {
	...
	public String clean(String bodyHtml, XssType type) {
		...
		NqBoardXssProperties.Mode mode = properties.getMode();
		if (NqBoardXssProperties.Mode.escape == mode) {
			// html 转义
			return HtmlUtils.htmlEscape(bodyHtml, CharsetUtil.UTF_8);
		}
		else if (NqBoardXssProperties.Mode.validate == mode) {
			// 校验
