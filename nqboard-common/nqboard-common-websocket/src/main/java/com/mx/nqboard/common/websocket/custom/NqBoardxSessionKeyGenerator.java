package com.mx.nqboard.common.websocket.custom;
...
public class NqBoardxSessionKeyGenerator implements SessionKeyGenerator {

	/**
	 * 根据 WebSocket 会话中的用户信息生成会话的唯一标识。
	 * <p>
	 * 此实现从会话属性中获取 {@link NqBoardUser} 对象，并使用其 ID 作为唯一标识。
	 * </p>
	...
	public Object sessionKey(WebSocketSession webSocketSession) {
		...
		if (obj instanceof NqBoardUser) {
			NqBoardUser user = (NqBoardUser) obj;
			// userId 作为唯一区分
