...
package com.mx.nqboard.common.log.event;
...
import com.mx.nqboard.common.core.jackson.NqBoardJavaTimeModule;
...
public class SysLogListener implements InitializingBean {
	...
	private final NqBoardLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		objectMapper.registerModule(new NqBoardJavaTimeModule());
	}
