 ...
 */
@FeignClient(contextId = "remoteStockMotHolderService", value = ServiceNameConstants.QUANTA_SERVICE)
public interface RemoteStockMotHolderService {
	 ...
	 */
	@NoToken
	@PostMapping("/stockMotHolder/sync")
