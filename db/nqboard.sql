...
INSERT INTO `nqboard`.`sys_menu` (`menu_id`, `name`, `en_name`, `permission`, `path`, `parent_id`, `icon`, `visible`, `sort_order`, `keep_alive`, `embedded`, `menu_type`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`) VALUES (2090441326455226369, '股票日线', NULL, NULL, '/quanta/stockDaily/index', 2090421625264017410, 'iconfont icon-yangan', '1', 2, '0', '0', '0', 'admin', '2026-08-20 22:10:25', 'admin', '2026-08-20 22:10:59', '0');
-- ----------------------------
