...
INSERT INTO `config_info` VALUES (13, 'nqboard-workflow-biz-dev.yml', 'DEFAULT_GROUP', '# 数据源\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    username: ${MYSQL_USERNAME:root}\n    password: ${MYSQL_PASSWORD:root}\n    url: jdbc:mysql://${MYSQL_HOST:127.0.0.1}:${MYSQL_PORT:3306}/${MYSQL_DB:nqboard_flw}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowMultiQueries=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Asia/Shanghai&nullCatalogMeansCurrent=true&allowPublicKeyRetrieval=true\n\n\n\n# 工作流配置项\nflowable:\n  #异步执行\n  async-executor-activate: true\n  #自动更新数据库\n  database-schema-update: true\n  #校验流程文件，默认校验resources下的processes文件夹里的流程文件\n  process-definition-location-prefix: classpath*:/processes/\n  process-definition-location-suffixes: \"**.bpmn20.xml, **.bpmn\"\n\n\n# 定义无需登录即可访问的api\nsecurity:\n  xss:\n    # 不进行拦截路径\n    path-exclude-patterns:\n    - /flowDefinition', '1d0d3994697d37f3a6339a768b2f026c', '2026-05-28 19:11:32', '2026-05-28 19:57:42', 'nacos', '172.19.0.1', '', 'public', '', NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` VALUES (14, 'nqboard-gateway-dev.yml', 'DEFAULT_GROUP', 'spring:\n  cloud:\n    gateway:\n      server:\n        webflux:\n          routes:\n            # 认证中心\n            - id: nqboard-auth\n              uri: lb://nqboard-auth\n              predicates:\n                - Path=/auth/**\n            #UPMS 模块\n            - id: nqboard-upms-biz\n              uri: lb://nqboard-upms-biz\n              predicates:\n                - Path=/admin/**\n              filters:\n                # 限流配置\n                - name: RequestRateLimiter\n                  args:\n                    key-resolver: \'#{@remoteAddrKeyResolver}\'\n                    redis-rate-limiter.replenishRate: 100\n                    redis-rate-limiter.burstCapacity: 200\n            #DEVICE 模块\n            - id: nqboard-device-biz\n              uri: lb://nqboard-device-biz\n              predicates:\n                - Path=/device/**\n              filters:\n                # 限流配置\n                - name: RequestRateLimiter\n                  args:\n                    key-resolver: \'#{@remoteAddrKeyResolver}\'\n                    redis-rate-limiter.replenishRate: 100\n                    redis-rate-limiter.burstCapacity: 200\n            #quanta 模块\n            - id: nqboard-quanta-biz\n              uri: lb://nqboard-quanta-biz\n              predicates:\n                - Path=/quanta/**\n              filters:\n                # 限流配置\n                - name: RequestRateLimiter\n                  args:\n                    key-resolver: \'#{@remoteAddrKeyResolver}\'\n                    redis-rate-limiter.replenishRate: 100\n                    redis-rate-limiter.burstCapacity: 200\n            # 代码生成模块\n            - id: nqboard-codegen\n              uri: lb://nqboard-codegen\n              predicates:\n                - Path=/gen/**\n            # 代码生成模块\n            - id: nqboard-quartz\n              uri: lb://nqboard-quartz\n              predicates:\n                - Path=/job/**\n            # 固定路由转发配置 无修改\n            - id: openapi\n              uri: lb://nqboard-gateway\n              predicates:\n                - Path=/v3/api-docs/**\n              filters:\n                - RewritePath=/v3/api-docs/(?<path>.*), /$\\{path}/$\\{path}/v3/api-docs', 'ffdfc9de2c7eada565cf975816398b59', '2026-08-19 22:18:03', '2026-08-19 22:18:03', 'nacos_namespace_migrate', '172.18.0.1', '', '', '', NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` VALUES (15, 'nqboard-quanta-biz-dev.yml', 'DEFAULT_GROUP', '# 数据源\r\nspring:\r\n  datasource:\r\n    type: com.zaxxer.hikari.HikariDataSource\r\n    driver-class-name: com.mysql.cj.jdbc.Driver\r\n    username: ${MYSQL_USERNAME:root}\r\n    password: ${MYSQL_PASSWORD:root}\r\n    url: jdbc:mysql://${MYSQL_HOST:127.0.0.1}:${MYSQL_PORT:3306}/${MYSQL_DB:nqboard_device}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowMultiQueries=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Asia/Shanghai&nullCatalogMeansCurrent=true&allowPublicKeyRetrieval=true', '8cef8300d17678d9a924bd1fa26e066a', '2026-08-19 22:20:16', '2026-08-19 22:20:16', 'nacos_namespace_migrate', '172.18.0.1', '', '', NULL, NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` VALUES (16, 'nqboard-quanta-biz-dev.yml', 'DEFAULT_GROUP', '# 数据源\r\nspring:\r\n  datasource:\r\n    type: com.zaxxer.hikari.HikariDataSource\r\n    driver-class-name: com.mysql.cj.jdbc.Driver\r\n    username: ${MYSQL_USERNAME:root}\r\n    password: ${MYSQL_PASSWORD:root}\r\n    url: jdbc:mysql://${MYSQL_HOST:127.0.0.1}:${MYSQL_PORT:3306}/${MYSQL_DB:nqboard_device}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowMultiQueries=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Asia/Shanghai&nullCatalogMeansCurrent=true&allowPublicKeyRetrieval=true', '8cef8300d17678d9a924bd1fa26e066a', '2026-08-19 22:20:16', '2026-08-19 22:20:16', 'nacos', '172.18.0.1', '', 'public', NULL, NULL, NULL, 'yaml', NULL, '');
...
-- ----------------------------
INSERT INTO `group_capacity` VALUES (1, '', 0, 16, 0, 0, 0, 0, '2026-03-18 10:18:55', '2026-08-19 22:20:26');
...
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '多租户改造' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of his_config_info
-- ----------------------------
INSERT INTO `his_config_info` VALUES (4, 17, 'nqboard-gateway-dev.yml', 'DEFAULT_GROUP', '', 'spring:\r\n  cloud:\r\n    gateway:\r\n      server:\r\n        webflux:\r\n          routes:\r\n            # 认证中心\r\n            - id: nqboard-auth\r\n              uri: lb://nqboard-auth\r\n              predicates:\r\n                - Path=/auth/**\r\n            #UPMS 模块\r\n            - id: nqboard-upms-biz\r\n              uri: lb://nqboard-upms-biz\r\n              predicates:\r\n                - Path=/admin/**\r\n              filters:\r\n                # 限流配置\r\n                - name: RequestRateLimiter\r\n                  args:\r\n                    key-resolver: \'#{@remoteAddrKeyResolver}\'\r\n                    redis-rate-limiter.replenishRate: 100\r\n                    redis-rate-limiter.burstCapacity: 200\r\n            #DEVICE 模块\r\n            - id: nqboard-device-biz\r\n              uri: lb://nqboard-device-biz\r\n              predicates:\r\n                - Path=/device/**\r\n              filters:\r\n                # 限流配置\r\n                - name: RequestRateLimiter\r\n                  args:\r\n                    key-resolver: \'#{@remoteAddrKeyResolver}\'\r\n                    redis-rate-limiter.replenishRate: 100\r\n                    redis-rate-limiter.burstCapacity: 200\r\n            # 代码生成模块\r\n            - id: nqboard-codegen\r\n              uri: lb://nqboard-codegen\r\n              predicates:\r\n                - Path=/gen/**\r\n            # 代码生成模块\r\n            - id: nqboard-quartz\r\n              uri: lb://nqboard-quartz\r\n              predicates:\r\n                - Path=/job/**\r\n            # 固定路由转发配置 无修改\r\n            - id: openapi\r\n              uri: lb://nqboard-gateway\r\n              predicates:\r\n                - Path=/v3/api-docs/**\r\n              filters:\r\n                - RewritePath=/v3/api-docs/(?<path>.*), /$\\{path}/$\\{path}/v3/api-docs', '7c71ddc57e38b87e9478bef455a6ab79', '2026-08-19 22:18:02', '2026-08-19 22:18:03', 'nacos', '172.18.0.1', 'U', 'public', '', 'formal', '', '{\"type\":\"yaml\",\"src_user\":\"nacos_namespace_migrate\"}');
INSERT INTO `his_config_info` VALUES (0, 18, 'nqboard-quanta-biz-dev.yml', 'DEFAULT_GROUP', '', '# 数据源\r\nspring:\r\n  datasource:\r\n    type: com.zaxxer.hikari.HikariDataSource\r\n    driver-class-name: com.mysql.cj.jdbc.Driver\r\n    username: ${MYSQL_USERNAME:root}\r\n    password: ${MYSQL_PASSWORD:root}\r\n    url: jdbc:mysql://${MYSQL_HOST:127.0.0.1}:${MYSQL_PORT:3306}/${MYSQL_DB:nqboard_device}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowMultiQueries=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Asia/Shanghai&nullCatalogMeansCurrent=true&allowPublicKeyRetrieval=true', '8cef8300d17678d9a924bd1fa26e066a', '2026-08-19 22:20:16', '2026-08-19 22:20:16', 'nacos', '172.18.0.1', 'I', 'public', '', 'formal', '', '{\"src_user\":\"nacos\",\"type\":\"yaml\"}');
...
-- ----------------------------
INSERT INTO `tenant_capacity` VALUES (1, 'public', 0, 11, 0, 0, 0, 0, '2026-03-18 10:18:55', '2026-08-19 22:20:26');
